...
export default function Footer() {
  ...
  return (
    <div className="text-center">
      <h1 className="text-[48px] mt-12 text-purple">
        {data[language].footer.title}
      </h1>
      <p className="text-[24px] mt-8 text-[#120B39]">
        {data[language].footer.description}
      </p>
      <a
        href="#"
        className="cursor-pointer text-[20px] mt-8 text-purple underline underline-offset-2"
      >
